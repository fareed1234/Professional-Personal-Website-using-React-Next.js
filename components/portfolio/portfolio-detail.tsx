  ...
  return (
    <main className="min-h-screen bg-white dark:bg-[#111111]">
      ...
      <div className="container py-12">
        <Link href="/portfolio" className="inline-flex items-center text-gray-400 hover:text-[#2768e1] mb-8">
            ...
            <div className="sticky top-24 bg-white dark:bg-[#272829] p-6 rounded-3xl card">
              ...
              {project.projectUrl && (
                <a
                  ...
                  className="flex items-center justify-center gap-2 w-full py-3 px-4 bg-[#2768e1] text-white rounded-lg text-base font-medium hover:bg-opacity-90 transition-colors"
                >
                  Visit Project
