          ...
          <div className="mt-8 flex flex-wrap gap-4">
            {project.projectUrl && (
              <a
                ...
                className="inline-flex items-center gap-2 px-6 py-2.5 bg-[#2768e1] text-white rounded-md hover:bg-opacity-90 transition-all text-sm font-medium shadow-sm"
              >
                Visit Project
            ...
            <Link
              ...
              className="inline-flex items-center text-gray-700 dark:text-gray-300 hover:text-[#2768e1] dark:hover:text-[#2768e1] text-sm font-medium"
              onClick={onClose}
            >
