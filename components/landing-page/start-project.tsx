      ...
      mutations.forEach((mutation) => {
        if (mutation.addedNodes.length) {
          ...
          if (iframe) {
            ...
            try {
              const iframeDoc = iframe.ownerDocument || iframe.ownerDocument
      ...
      <div className="max-w-5xl mx-auto w-full">
        <div className="mb-10 text-center">
          <h2 className="text-black dark:text-white text-4xl md:text-6xl font-medium">
            Ready to Start <br />
            Your New <span className="text-[#2768e1]">Project</span>?
          </h2>
        ...
        <div className="form-container max-w-xl mx-auto p-6 rounded-3xl bg-[#272829] shadow-md relative overflow-hidden">
          ...
          {/* Tally Form Embed */}
          <iframe
            data-tally-src={`https://tally.so/r/wgEGLl?transparentBackground=1" width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0" title=Contact form"${
              resolvedTheme || "dark"
            }`}
            loading="lazy"
            width="100%"
