...
export default function Header() {
  ...
  const logoSrc = mounted && resolvedTheme === "dark" ? "/logo-light-text.png" : "/logo-dark-text.png"
                  ...
                  <li>
                    <Link
                      ...
                      className={`transition-colors ${
                        pathname === "/portfolio"
                          ? "text-[#2768e1] dark:text-[#2768e1]"
                          : "text-black dark:text-white hover:text-[#2768e1] dark:hover:text-[#2768e1]"
                      }`}
                    >
                      Portfolio
                    </Link>
